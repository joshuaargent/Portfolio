              ...
              <Card>
                ...
                <div className="space-y-3">
                  ...
                  <a
                    ...
                    className="hover:bg-bg-secondary flex items-center gap-3 rounded-lg p-2 transition-colors"
                  >
                    <svg className="h-5 w-5 text-orange-500" viewBox="0 0 24 24">
